...
films = sn.get_note("a74f34d0-6494-4388-8206-eac773459ed9")[0].get("content")
tv = sn.get_note("a1dac99ff06d4e39a50dee8b8f61e9c8")[0].get("content")
book = sn.get_note("d37783453d284856bb3846d684c0a9cc")[0].get("content")
